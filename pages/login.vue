...
.wraper {
  ...
  box-shadow: 0px 0px 30px 20px rgba(57, 106, 255, 0.1);
  color: var(--text);
  display: flex;
...
.input .username input:not(:placeholder-shown) + label {
  /* bottom: 64px;
  left: 8px; */
  top: -5px;
  left: 10px;
...
.input .password input:not(:placeholder-shown) + label {
  /* bottom: 64px;
  left: 8px; */
  top: -5px;
  left: 10px;
